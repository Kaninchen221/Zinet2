...
namespace zt::vulkan_renderer::tests
{
	...
	protected:
		...
		static_assert(std::is_base_of_v<VulkanObject<VkFence>, Fence>);

		static_assert(std::is_constructible_v<Fence, VkFence>);
		static_assert(!std::is_default_constructible_v<Fence>);
		static_assert(!std::is_copy_constructible_v<Fence>);
		static_assert(!std::is_copy_assignable_v<Fence>);
		static_assert(std::is_move_constructible_v<Fence>);
		static_assert(std::is_move_assignable_v<Fence>);
		static_assert(std::is_destructible_v<Fence>);
	};
