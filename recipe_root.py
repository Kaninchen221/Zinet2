...
root.subdirectories = ["CoreLib", "SoftwareRendererLib", "OpenGLRendererLib", "WindowLib", "MathLib", "GameplayLib", "ThirdParty/ImGuiLib", "ThirdParty/Glad"]
...
root.globalCompileDefinitions = "_DISABLE_VECTOR_ANNOTATION _DISABLE_STRING_ANNOTATION _SILENCE_STDEXT_ARR_ITERS_DEPRECATION_WARNING ZINET_USE_OPENGL ZINET_ROOT_PATH=\"${CMAKE_CURRENT_SOURCE_DIR}\""
