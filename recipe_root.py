...
root.subdirectories = ["CoreLib", "VulkanRendererLib", "WindowLib", "MathLib", "GameplayLib", "TestUtilsLib", "SoftwareRendererLib", "ComputerSystemsLib", "Sandbox", "ThirdParty/ImGuiLib", "ThirdParty/ImPlotLib"]
