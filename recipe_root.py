...
root.subdirectories = ["CoreLib", "VulkanRendererLib", "WindowLib", "MathLib", "GameplayLib", "TestUtilsLib", "SoftwareRendererLib", "ComputerSystemsLib", "Sandbox", "ZinetNativeLangLib", "ThirdParty/ImGuiLib", "ThirdParty/ImPlotLib"]
...
root.globalCompileDefinitions = "ZINET_STATIC ZINET_ROOT_PATH=\"${CMAKE_CURRENT_SOURCE_DIR}\" _DISABLE_STRING_ANNOTATION _DISABLE_VECTOR_ANNOTATION"
