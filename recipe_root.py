...
root.subdirectories = ["CoreLib", "VulkanRendererLib", "WindowLib", "MathLib", "GameplayLib", "TestUtilsLib", "SoftwareRendererLib", "Sandbox", "ThirdParty/ImGuiLib", "ThirdParty/ImPlotLib"]
